...
public class ReportDisasterController {
    ...
    // --- Form fields ---
    @FXML private ComboBox<DisasterType>   typeComboBox;
    ...
    @FXML private TableView<DisasterReport>      recentReportsTable;
    ...
    private void handleSubmit() {
        ...
        statusLabel.setText("Report #" + report.getId() + " submitted successfully. Priority: " + report.getPriority());
        loadRecentReports();
        clearForm();
    }
