...
public class ResourceController {
    ...
    @FXML private Label deptAvailableLabel;
    @FXML private Label deptDeployedLabel;
    @FXML private Label respAvailableLabel;
    @FXML private Label respDeployedLabel;
    ...
    @FXML private TableColumn<Department, String>    deptTypeCol;
    @FXML private TableColumn<Department, String>    deptContactCol;
    @FXML private TableColumn<Department, String>    deptPhoneCol;
    @FXML private TableColumn<Department, String>    deptStatusCol;
    @FXML private Button                             toggleDeptBtn;
    @FXML private Label                              deptStatusLabel;

    // --- Responders table ---
    @FXML private TableView<Responder>               respTable;
    @FXML private TableColumn<Responder, Integer>    respIdCol;
    @FXML private TableColumn<Responder, String>     respNameCol;
    @FXML private TableColumn<Responder, String>     respRoleCol;
    @FXML private TableColumn<Responder, String>     respDeptCol;
    @FXML private TableColumn<Responder, String>     respPhoneCol;
    @FXML private TableColumn<Responder, String>     respStatusCol;
    @FXML private Button                             toggleRespBtn;
    @FXML private Label                              respStatusLabel;
